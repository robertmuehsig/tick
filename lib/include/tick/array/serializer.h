...
inline SSparseArrayAtomicFloat2dPtr tick_atomic_float_sparse2d_from_file(
    std::string _file) {
  return array_from_file<SSparseArrayAtomicFloat2d>(_file);
}
inline SArrayAtomicFloatPtr tick_atomic_float_array_from_file(
    std::string _file) {
  return array_from_file<SArrayAtomicFloat>(_file);
}
